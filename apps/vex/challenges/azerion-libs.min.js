var _azerionIntegration = {
  gdId: "b657d0d7da2e46919d24862aa1f3e758",
  alxType: "std",
  advType: "gd",
  af: !1,
  sa: !1,
          ...
          7: [function(require, module, exports) {
            ...
            require.prototype.animate = function animate(progress, opts, cb) {
              ...
              require.prototype._warnContainerAspectRatio = function _warnContainerAspectRatio(container) {
                ...
                this.containerAspectRatio && (container = window.getComputedStyle(container, null),
                  width = parseFloat(container.getPropertyValue("width"), 10),
                  container = parseFloat(container.getPropertyValue("height"), 10),
                  utils.floatEquals(this.containerAspectRatio, width / container))
              },
              module.exports = require
          }, {
            "./path": 5,
      ...
      SplashLoader.prototype.setLoadProgress = function(progress) {
        ...
        this.loaded && (100 === (this.progress = progress = 30 + .7 * progress) ? (button_1 = document.querySelector("#h5branding-button"),
          this.circleLoader.animate(1, null, function() {
            ...
            !Utils.inGDGameZone() && button_1 && !0 === _this.showPlayButton ? _this.onPlayButtonClick() : !Utils.inGDGameZone() && !1 !== _this.showPlayButton || _this.onPlayButtonClick()
...
(() => {
  var __webpack_modules__ = {
            ...
            var JioAdProvider = function() {
              ...
              return JioAdProvider.prototype.setManager = function(manager) {
                  ...
                  this.adManager = manager,
                    this.jioGamesSP = null == (manager = window._azerionJGSDK) ? void 0 : manager.JioGamesSP
                },
                JioAdProvider.prototype.showAd = function(adType) {
                  adType === shared_1.AdType.interstitial ? this.jioGamesSP.showAdMidRoll() : adType === shared_1.AdType.rewarded && this.jioGamesSP.showAdRewardedVideo(),
                    this.resumeGameplay()
                },
                JioAdProvider.prototype.resumeGameplay = function() {
                  this.adManager.emit(shared_1.AdEvents.CONTENT_RESUMED)
                },
                JioAdProvider.prototype.preloadAd = function(adType, adSpotKey, packageName) {
                  (adType = void 0 === adType ? shared_1.AdType.interstitial : adType) === shared_1.AdType.interstitial && this.jioGamesSP.cacheAdMidRoll(adSpotKey, packageName),
                    adType === shared_1.AdType.rewarded && this.jioGamesSP.cacheAdRewardedVideo(adSpotKey, packageName)
                },
    ...
    592: (module, exports, __webpack_require__) => {
      var __webpack_require__, exports;
      __webpack_require__ = [__webpack_require__, exports, __webpack_require__(260)],
        void 0 !== (exports = function(require, exports, dummy_1) {
            "use strict";
            Object.defineProperty(exports, "__esModule", {
                value: !0
              }),
            ...
            var DummyBanner = function() {
              ...
              return DummyBanner.prototype.getBoundingClientRect = function() {
                ...
                DummyBanner.prototype.getUpdatedPosition = function() {
                  ...
                  switch (this.alignment) {
                    ...
                    case dummy_1.DummyAlignment.TopCenter:
                      x = parentBoundingRect.left + parentBoundingRect.width / 2 - this.width * this.scaleFactor / 2,
                        y = parentBoundingRect.top;
                      break;
                    case dummy_1.DummyAlignment.TopRight:
                      x = parentBoundingRect.left + parentBoundingRect.width - this.width * this.scaleFactor,
                        y = parentBoundingRect.top;
                      break;
                    case dummy_1.DummyAlignment.CenterLeft:
                      x = parentBoundingRect.left,
                        y = parentBoundingRect.top + parentBoundingRect.height / 2 - this.height * this.scaleFactor / 2;
                      break;
                    ...
                    case dummy_1.DummyAlignment.BottomLeft:
                      x = parentBoundingRect.left,
                        y = parentBoundingRect.top + parentBoundingRect.height - this.height * this.scaleFactor;
                      break;
                ...
                DummyBanner.prototype.alignIn = function(alignment) {
                  ...
                  this.element.style.left = "".concat(alignment.x + this.offsetX, "px"),
                    this.element.style.top = "".concat(alignment.y + this.offsetY, "px")
                },
                ...
                DummyBanner.prototype.setSize = function(sizeType) {
                  ...
                  var resultArr;
                  resultArr && 0 < resultArr.length && (resultArr = resultArr[0],
                    this.width = resultArr.width,
                    this.height = resultArr.height,
    ...
    670: (module, exports, __webpack_require__) => {
      var __webpack_require__, exports;
      __webpack_require__ = [__webpack_require__, exports, __webpack_require__(12), __webpack_require__(592)],
        void 0 !== (exports = function(require, exports, shared_1, DummyBanner_1) {
            "use strict";
            Object.defineProperty(exports, "__esModule", {
                value: !0
              }),
    ...
    474: (module, exports, __webpack_require__) => {
      var __webpack_require__, exports;
      __webpack_require__ = [__webpack_require__, exports, __webpack_require__(12), __webpack_require__(444)],
        void 0 !== (exports = function(require, exports, shared_1, GameDistributionBanner_1) {
            "use strict";
              ...
              return GameDistribution.prototype.setManager = function(manager) {
                ...
                GameDistribution.prototype.showAd = function(adType) {
                  ...
                  this.adsEnabled ? void 0 === window.gdsdk || window.gdsdk && void 0 === window.gdsdk.showAd ? (this.adsEnabled = !1,
                    this.adManager.emit(shared_1.AdEvents.CONTENT_RESUMED)) : window.gdsdk.showAd(adType === shared_1.AdType.rewarded ? GameDistributionAdType.rewarded : GameDistributionAdType.interstitial).catch(function() {
            ...
            var GameDistributionBanner = function() {
              ...
              return GameDistributionBanner.prototype.getBoundingClientRect = function() {
                ...
                GameDistributionBanner.prototype.alignIn = function(position) {
                  var _this = this;
                  this.parent || (this.parent = this.getBoundingClientRect(),
          ...
          Object.defineProperty(exports, "__esModule", {
            ...
            function(DummyBannerSize) {
              DummyBannerSize[DummyBannerSize.LargeRectangle = 0] = "LargeRectangle",
                ...
                DummyBannerSize[DummyBannerSize.WideSkyscraper = 5] = "WideSkyscraper"
