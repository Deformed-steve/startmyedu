var _azerionIntegration = {
  gdId: "949009d40a2846f89f887de2285d6c28",
  alxType: "std",
  advType: "gd",
  af: !1,
  sa: !1,
...
! function(global, factory) {
      ...
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            ...
            case 3:
              return result = _a.sent(), console.log(result), [3, 4];
            case 4:
      ...
      return function e(t, n, r) {
        ...
        7: [function(require, module, exports) {
          ...
          require.prototype.animate = function animate(progress, opts, cb) {
            ...
            this.containerAspectRatio && (computedStyle = window.getComputedStyle(container, null), width = parseFloat(computedStyle.getPropertyValue("width"), 10), height = parseFloat(computedStyle.getPropertyValue("height"), 10), utils.floatEquals(this.containerAspectRatio, width / height) || (console.warn("Incorrect aspect ratio of container", "#" + container.id, "detected:", computedStyle.getPropertyValue("width") + "(width)", "/", computedStyle.getPropertyValue("height") + "(height)", "=", width / height), console.warn("Aspect ratio of should be", this.containerAspectRatio)))
          }, module.exports = require
        }, {
          "./path": 5,
          "./utils": 9
  ...
  var AeriaIntegration = function() {
    ...
    return AeriaIntegration.updateAeriaIFrameSrc = function() {
      ...
      if (isHostAeria && window.hasOwnProperty("gdsdk")) {
      ...
      __webpack_require__ = [__webpack_require__, exports, __webpack_require__(12)], void 0 !== (exports = function(require, exports, shared_1) {
        ...
        var JioAdProvider = function() {
          ...
          return JioAdProvider.prototype.setManager = function(manager) {
            ...
            void 0 === adType && (adType = shared_1.AdType.interstitial), console.log("Calling cache Jio Ad"), adType === shared_1.AdType.interstitial && this.jioGamesSP.cacheAdMidRoll(), adType === shared_1.AdType.rewarded && this.jioGamesSP.cacheAdRewarded()
      ...
      __webpack_require__ = [__webpack_require__, exports, __webpack_require__(260)], void 0 !== (exports = function(require, exports, dummy_1) {
        ...
        var DummyBanner = function() {
          ...
          return DummyBanner.prototype.getBoundingClientRect = function() {
            ...
            return console.log("[Dummy]:Banner Available =>", 0 === num), new Promise(function(resolve, reject) {
      ...
      __webpack_require__ = [__webpack_require__, exports, __webpack_require__(12), __webpack_require__(592)], void 0 !== (exports = function(require, exports, shared_1, DummyBanner_1) {
        ...
        var DummyProvider = function() {
          ...
          return DummyProvider.prototype.setManager = function(manager) {
            this.adManager = manager, this.adsEnabled = !0
          }, DummyProvider.prototype.showAd = function(adType) {
            var _this = this;
            void 0 === adType && (adType = shared_1.AdType.interstitial), console.log("[Dummy]: Ad type requested = ", adType === shared_1.AdType.interstitial ? "interstitial" : "rewarded"), this.adManager.emit(shared_1.AdEvents.CONTENT_PAUSED);
            var num = Math.floor(2 * Math.random());
            console.log("[Dummy]:Ad Available =>", 0 === num), 1 === num ? (console.log("[Dummy]:AD ERROR / UNAVAILABLE"), setTimeout(function() {
              console.log("[Dummy]: Resuming game"), _this.resumeGameplay()
            }, 200)) : (adType === shared_1.AdType.rewarded && setTimeout(function() {
              console.log("[Dummy]: Reward Claimed for rewarded ad"), _this.adManager.emit(shared_1.AdEvents.AD_REWARDED)
            }, 100), setTimeout(function() {
              console.log("[Dummy]: Finished watching ad"), console.log("[Dummy]: Resuming game"), _this.resumeGameplay()
            }, 200))
      ...
      __webpack_require__ = [__webpack_require__, exports, __webpack_require__(12), __webpack_require__(444)], void 0 !== (exports = function(require, exports, shared_1, GameDistributionBanner_1) {
        ...
        var GameDistribution = function() {
          ...
          return GameDistribution.prototype.setManager = function(manager) {
            this.adManager = manager, this.adManager.emit(shared_1.AdEvents.AD_PROVIDER_LOADED)
          }, GameDistribution.prototype.sdkLoaded = function() {
            this.adsEnabled = !0
          }, GameDistribution.prototype.showAd = function(adType) {
            var _this = this;
            this.adsEnabled ? void 0 === window.gdsdk || window.gdsdk && void 0 === window.gdsdk.showAd ? (this.adsEnabled = !1, this.adManager.emit(shared_1.AdEvents.CONTENT_RESUMED)) : window.gdsdk.showAd(adType === shared_1.AdType.rewarded ? GameDistributionAdType.rewarded : GameDistributionAdType.interstitial).catch(function() {
            ...
            var _this = this;
            !this.hasRewarded && this.adsEnabled && adType === shared_1.AdType.rewarded && (console.log("preloading ad"), window.gdsdk.preloadAd(GameDistributionAdType.rewarded).then(function() {
            ...
            var size;
            return this.adsEnabled ? ((size = new GameDistributionBanner_1.GameDistributionBanner(size)).loadBanner().catch(function() {
      ...
      __webpack_require__ = [__webpack_require__, exports, __webpack_require__(474), __webpack_require__(869)], void 0 !== (exports = function(require, exports, GameDistribution_1, gamedistribution_1) {
        ...
        var GameDistributionBanner = function() {
          ...
          return GameDistributionBanner.prototype.getBoundingClientRect = function() {
            ...
            var _this = this;
            this.parent ? console.warn("Banner already aligned, ignoring...") : (this.parent = this.getBoundingClientRect(), this.alignment = position, this.resizeListener = function() {
              return _this.resize()
        ...
        var YandexAdProvider = function() {
          ...
          return YandexAdProvider.prototype.setManager = function(manager) {
            ...
            void 0 === adType && (adType = shared_1.AdType.interstitial), this.adsEnabled && window.hasOwnProperty("_YaSDK") ? adType === shared_1.AdType.interstitial && null != (_a = null == (_a = window._YaSDK) ? void 0 : _a.adv) && _a.adOpened || (adType === shared_1.AdType.rewarded ? null != (_a = null == (adType = null == (_a = window._YaSDK) ? void 0 : _a.adv) ? void 0 : adType.showRewardedVideo) && _a.call(adType, {
              callbacks: {
                onOpen: function() {
                  console.log("Video ad open."), _this.adManager.emit(shared_1.AdEvents.CONTENT_PAUSED)
                },
                onRewarded: function() {
                  console.log("Rewarded!"), _this.adManager.emit(shared_1.AdEvents.AD_REWARDED)
                },
                onClose: function() {
                  console.log("Video ad closed."), _this.resumeGameplay()
                },
                onError: function(e) {
                  console.log("Error while open video ad:", e), _this.resumeGameplay()
                }
              }
