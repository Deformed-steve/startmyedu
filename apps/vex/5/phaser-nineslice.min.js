    ...
    return __extends(b, a), b.prototype.renderTexture = function() {
      ...
      for (var e = 0; e < 3; e++)
        for (var f = 0; f < 3; f++) {
          ...
          g.width = c[f + 1] - c[f], g.height = d[e + 1] - d[e], this.texture.renderXY(g, c[f], d[e])
        }
    }, b.prototype.resize = function(a, b) {
      this.localWidth = a, this.localHeight = b, this.renderTexture()
    }, b.prototype.destroy = function() {
      for (var b = [], c = 0; c < arguments.length; c++) b[c] = arguments[c];
      a.prototype.destroy.call(this, b[0]), this.texture.destroy(!0), this.texture = null, this.baseTexture = null, this.baseFrame = null
...
! function(a) {
  var b = function(b) {
    function c(a, c) {
      ...
      return d.addNineSliceCache(), d.addNineSliceFactory(), d.addNineSliceLoader(), d
    }
    return __extends(c, b), c.prototype.addNineSliceLoader = function() {
      Phaser.Loader.prototype.nineSlice = function(a, b, c, d, e, f) {
        var g = {
          top: c
        };
        d && (g.left = d), e && (g.right = e), f && (g.bottom = f), this.addToFileList("image", a, b), this.game.cache.addNineSlice(a, g)
      }
      ...
      Phaser.Cache.prototype.nineSlice = {}, Phaser.Cache.prototype.addNineSlice = function(a, b) {
        this.nineSlice[a] = b
