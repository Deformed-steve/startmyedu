...
var _0x530c = function(_0x19a0af, _0x11786c) {
  _0x19a0af = _0x19a0af - 0x0;
  var _0x530c5c = _0x1178[_0x19a0af];
  return _0x530c5c;
};
var Imported = Imported || {};
Imported[_0x530c('0x25')] = !![];
var Olivia = Olivia || {};
var parameters = $plugins[_0x530c('0xf')](function(_0xd81664) {
  return _0xd81664[_0x530c('0x31')][_0x530c('0xa')](_0x530c('0x15'));
})[0x0][_0x530c('0xc')];
Olivia[_0x530c('0x21')] = {
  'defaultLoop': eval(parameters[_0x530c('0x1d')]),
  'defaultWaitFrames': Math[_0x530c('0x29')](0x1, Number(parameters[_0x530c('0x3')]))
};
Olivia[_0x530c('0x21')][_0x530c('0x32')] = Game_Screen[_0x530c('0x20')][_0x530c('0x8')];
Game_Screen['prototype'][_0x530c('0x8')] = function() {
  Olivia[_0x530c('0x21')]['___Game_Screen_initialize___'][_0x530c('0x23')](this);
  this[_0x530c('0x37')]();
};
Game_Screen[_0x530c('0x20')][_0x530c('0x37')] = function() {
  this[_0x530c('0x16')] = [];
  this[_0x530c('0x38')] = [];
};
Game_Screen['prototype'][_0x530c('0x1f')] = function(_0x3d1053) {
  if (this['_animatedPictureLoop'] === undefined) {
    this[_0x530c('0x37')]();
  }
  var _0x496bba = this[_0x530c('0x33')](_0x3d1053);
  if (this[_0x530c('0x16')][_0x496bba] === undefined) {
    this[_0x530c('0x16')][_0x496bba] = Olivia[_0x530c('0x21')][_0x530c('0x1a')];
  }
  return this[_0x530c('0x16')][_0x496bba];
};
Game_Screen[_0x530c('0x20')][_0x530c('0x6')] = function(_0x6b5c01, _0x3ecaac) {
  if (this['_animatedPictureLoop'] === undefined) {
    this[_0x530c('0x37')]();
  }
  var _0x249de7 = this[_0x530c('0x33')](_0x6b5c01);
  this[_0x530c('0x16')][_0x249de7] = _0x3ecaac;
};
Game_Screen[_0x530c('0x20')][_0x530c('0x24')] = function(_0x1f4629) {
  if (this[_0x530c('0x38')] === undefined) {
    this['initializeAnimatedPictureSettings']();
  }
  var _0x59a891 = this[_0x530c('0x33')](_0x1f4629);
  if (this[_0x530c('0x38')][_0x59a891] === undefined) {
    this['_animatedPictureWait'][_0x59a891] = Olivia[_0x530c('0x21')]['defaultWaitFrames'];
  }
  return this[_0x530c('0x38')][_0x59a891];
};
Game_Screen[_0x530c('0x20')]['setAnimatedPictureWaitFrames'] = function(_0x58e026, _0x19a143) {
  if (this[_0x530c('0x38')] === undefined) {
    this[_0x530c('0x37')]();
  }
  var _0x136ba5 = this[_0x530c('0x33')](_0x58e026);
  this[_0x530c('0x38')][_0x136ba5] = _0x19a143;
};
Olivia[_0x530c('0x21')][_0x530c('0x7')] = Game_Interpreter[_0x530c('0x20')][_0x530c('0x9')];
Game_Interpreter[_0x530c('0x20')][_0x530c('0x9')] = function(_0xc8b993, _0x32ac1e) {
  Olivia[_0x530c('0x21')]['___Game_Interpreter_pluginCommand___'][_0x530c('0x23')](this, _0xc8b993, _0x32ac1e);
  if (_0xc8b993[_0x530c('0x2f')](/AnimatedPicture/i)) {
    var _0x16c5f5 = _0x32ac1e['shift']();
    if (_0x16c5f5 > 0x0 && _0x16c5f5 <= $gameScreen[_0x530c('0x34')]()) {
      var _0x3e2ab3 = _0x32ac1e[_0x530c('0x28')]();
      if (_0x3e2ab3[_0x530c('0x2f')](/NoLoop/i)) {
        $gameScreen[_0x530c('0x6')](_0x16c5f5, ![]);
      } else if (_0x3e2ab3[_0x530c('0x2f')](/Loop/i)) {
        $gameScreen[_0x530c('0x6')](_0x16c5f5, !![]);
      } else if (_0x3e2ab3[_0x530c('0x2f')](/Speed/i)) {
        var _0xc2e3e5 = Math[_0x530c('0x29')](0x1, parseInt(_0x32ac1e['shift']()));
        $gameScreen[_0x530c('0x2a')](_0x16c5f5, _0xc2e3e5);
      } else if (_0x3e2ab3['match'](/Reset/i)) {
        $gameScreen[_0x530c('0x6')](_0x16c5f5, undefined);
        $gameScreen[_0x530c('0x2a')](_0x16c5f5, undefined);
      }
    } else {
      alert(_0x16c5f5 + _0x530c('0x4'));
    }
  }
};
Olivia['AnimatedPictures'][_0x530c('0x0')] = Sprite_Picture[_0x530c('0x20')][_0x530c('0x8')];
Sprite_Picture[_0x530c('0x20')]['initialize'] = function(_0x1839ba) {
  this[_0x530c('0x2c')]();
  Olivia['AnimatedPictures'][_0x530c('0x0')][_0x530c('0x23')](this, _0x1839ba);
};
Sprite_Picture[_0x530c('0x20')]['initializeAnimatedPicture'] = function() {
  this[_0x530c('0x27')] = ![];
  this[_0x530c('0x36')] = 0x1;
  this[_0x530c('0x30')] = 0x1;
  this[_0x530c('0x11')] = 0x1;
  this[_0x530c('0x5')] = 0x0;
  this[_0x530c('0x2')] = 0x0;
};
Olivia[_0x530c('0x21')]['___Sprite_Picture_loadBitmap___'] = Sprite_Picture['prototype'][_0x530c('0x19')];
Sprite_Picture[_0x530c('0x20')][_0x530c('0x19')] = function() {
  this[_0x530c('0x22')]();
  Olivia['AnimatedPictures'][_0x530c('0x1c')][_0x530c('0x23')](this);
  if (this[_0x530c('0x27')]) {
    this[_0x530c('0x26')][_0x530c('0x17')](this[_0x530c('0x2b')][_0x530c('0x18')](this));
  } else {
    this['bitmap'][_0x530c('0x17')](this[_0x530c('0x35')][_0x530c('0x18')](this));
  }
};
Sprite_Picture[_0x530c('0x20')][_0x530c('0x35')] = function() {
  this[_0x530c('0x13')](0x0, 0x0, this[_0x530c('0x26')][_0x530c('0x10')], this[_0x530c('0x26')][_0x530c('0x12')]);
};
Sprite_Picture[_0x530c('0x20')][_0x530c('0x22')] = function() {
  if (this[_0x530c('0x1')][_0x530c('0x2f')](/\[(\d+)x(\d+)\]/i)) {
    this[_0x530c('0x27')] = !![];
    this[_0x530c('0x36')] = Math[_0x530c('0x29')](0x1, parseInt(RegExp['$1']));
    this[_0x530c('0x30')] = Math[_0x530c('0x29')](0x1, parseInt(RegExp['$2']));
    this[_0x530c('0x11')] = this[_0x530c('0x36')] * this[_0x530c('0x30')];
  } else {
    this[_0x530c('0x27')] = ![];
    this[_0x530c('0x36')] = 0x1;
    this[_0x530c('0x30')] = 0x1;
  ...
  this['_animationCount'] = 0x0;
  this[_0x530c('0x2')] = 0x0;
};
Olivia[_0x530c('0x21')]['___Sprite_Picture_update___'] = Sprite_Picture[_0x530c('0x20')][_0x530c('0x1e')];
Sprite_Picture[_0x530c('0x20')][_0x530c('0x1e')] = function() {
  Olivia['AnimatedPictures'][_0x530c('0x1b')]['call'](this);
  if (this[_0x530c('0xd')] && this[_0x530c('0x27')]) {
    this['updateAnimatedPictureCount']();
  }
};
Sprite_Picture['prototype'][_0x530c('0x2d')] = function() {
  this[_0x530c('0x5')] += 0x1;
  if (this[_0x530c('0x5')] >= this['animationWaitFrames']()) {
    this[_0x530c('0x5')] = 0x0;
    this[_0x530c('0x2')] += 0x1;
    if (this[_0x530c('0x2')] >= this[_0x530c('0x11')]) {
      if (this[_0x530c('0xb')]()) {
        this[_0x530c('0x2')] = 0x0;
      } else {
        this[_0x530c('0x2')] = this[_0x530c('0x11')] - 0x1;
      }
    }
    this[_0x530c('0x2b')]();
  }
};
Sprite_Picture[_0x530c('0x20')][_0x530c('0x2b')] = function() {
  var _0x335e99 = this[_0x530c('0x26')][_0x530c('0x10')] / this[_0x530c('0x36')];
  var _0x7ee6b2 = this[_0x530c('0x26')][_0x530c('0x12')] / this['_animationVertCells'];
  var _0x423875 = this[_0x530c('0x2')] % this[_0x530c('0x36')] * _0x335e99;
  var _0x121409 = Math[_0x530c('0xe')](this['_animationIndex'] / this[_0x530c('0x36')]) * _0x7ee6b2;
  this[_0x530c('0x13')](_0x423875, _0x121409, _0x335e99, _0x7ee6b2);
};
Sprite_Picture[_0x530c('0x20')][_0x530c('0xb')] = function() {
  return $gameScreen[_0x530c('0x1f')](this[_0x530c('0x2e')]);
};
Sprite_Picture[_0x530c('0x20')][_0x530c('0x14')] = function() {
  return $gameScreen[_0x530c('0x24')](this[_0x530c('0x2e')]);
};