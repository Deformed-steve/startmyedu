...
VariableHud.prototype.createNumber = function() {
  ...
  this._number.bitmap.textColor = '#5017af'
...
VariableHud.prototype.needHide = function() {
  if ($gameMessage.isBusy() && $gameSystem._variableHudData[this._index].autoFade) {
    return true
  };
  if ($gameSystem._variableHudData[this._index] && !$gameSystem._variableHudData[this._index].visible) {
    return true
  };
